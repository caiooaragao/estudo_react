        ...
        <div>
          <form action="#" id="agendar-form">
            <div className="container formulario-box">
              <div className="row">
                <div className="col-12">
                  <div className="row">
                    ...
                    <div className="col-12">
                      <select className="select-class" name="selecionar-servico" id="selecionar-servico">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
              ...
              <div className="row">
                <div className="col-8">
                  <input type="date" id="data" name="data" className="select-class text-center"></input>
                  <p className="text-danger d-none" id="data-invalida">Data inválida</p>
    
                </div>
                <div className="col-4">
                  <input type="time" className="select-class text-center " name="hora" id="hora"></input>
